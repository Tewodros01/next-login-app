...
const schema = yup.object().shape({
  ...
  accountNumber: yup.number().required("Amount is required").positive("Amount must be positive"),
  ...
  return (
    <div className="flex flex-col gap-4">
      <form className=" grid grid-cols-4 gap-4">
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="accountName" className="text-sm font-bold text-gray-500">
            Account Name
          </label>
          <input
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="accountNumber" className="text-sm font-bold text-gray-500">
            Account Number
          </label>
          <input
            type="number"
